...
void entry(unsigned long magic, unsigned long addr) {
    ...
    rtc_init();
    f_init((uint32_t*)((module_t*)mbi->mods_addr)->mod_start);
...
// #endif
    ...
    execute((uint8_t*)"shell"); 
        //change to starting up all 3 terminals with shell to begin
            //pressing alt + f2/f3 will switch terminals after
